  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 gap-10">
      ...
      <div className="flex flex-col gap-3 w-full max-w-sm">
        ...
        <Link href="/sign-in" className="flex items-center justify-center w-full border border-zinc-700 text-white hover:bg-zinc-900 h-12 rounded-2xl text-base transition-colors">
          Sign In
        </Link>
      </div>
    </main>
