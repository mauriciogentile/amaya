        ...
        {activeTab === "exercises" && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 flex items-center justify-center gap-2 text-primary text-sm font-medium hover:text-primary/70 transition-colors"
            >
              <Plus size={16} />
              Add Exercise
            </button>
        ...
        <>
          ...
          <div className="fixed bottom-0 inset-x-0 z-50 bg-card border-t border-border rounded-t-2xl px-4 pt-4 pb-8 max-w-lg mx-auto">
            ...
            <button
              onClick={saveEdit}
              disabled={saving}
              className="w-full py-3 rounded-xl bg-primary hover:bg-primary/80 disabled:opacity-50 text-primary-foreground font-semibold flex items-center justify-center gap-2 transition-colors min-h-[44px]"
            >
              {saving ? (
